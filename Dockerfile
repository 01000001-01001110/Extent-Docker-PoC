...
# install all plugins listed up there using Jenkins CLI Plugin
RUN cat ${REF}/init.groovy.d/plugins.txt | xargs java -jar /usr/share/jenkins/jenkins-cli.jar -s http://localhost:8080 install-plugin
